...
int_predictions %>%
  ...
  labs(title = "Overall Model : Indonesia Prediction Results", x = "Actual WTP", y = "Predicted WTP") +
...
int_predictions %>%
  ...
  geom_errorbarh(aes(xmin =  bid_intervals_mean - (interval_range/2), xmax = bid_intervals_mean + (interval_range/2)), height = 0) +
  labs(title = "Overall Model : Mexico Prediction Results", x = "Actual WTP", y = "Predicted WTP") +
  geom_abline(intercept = 0, slope = 1) 
