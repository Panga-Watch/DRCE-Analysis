...
ggplot(test_group_df, aes(x = y, y = perc_opt_in)) +
  geom_point() +
  labs(x = "Payment to Fisher ($)", y = "Percent opt in VMS Program", title = "All Technology and Demographic Combinations") +
  theme_bw() +
...
ggplot(test_group_df_opt_out, aes(x = y, y = perc_opt_in)) +
  geom_point() +
  labs(x = "Payment to Fisher", y = "Percent opt out VMS Program", title = "All Technology and Demographic Combinations") +
  theme_bw() +
  scale_x_continuous(breaks = seq(-3,8, 1))
