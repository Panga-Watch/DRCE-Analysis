...
# avg_income_lower <- 590.83*12 - 1000
# avg_income_higher <- 590.83*12 + 1000
# lambda_hat <- avg_income/1000^2
# alpha_hat <- avg_income^2/1000^2
# 
...
#write.csv(psc_predict, "hypo_village_data/PuertoSanCarlos/PuertoSanCarlos_predictions.csv", row.names = FALSE)
...
for(i in unique(PSC_all_predictions$package)){
  ...
  save_plot(p, file = paste0("hypo_village_data/PuertoSanCarlos_gdp/graphs_gamma/", m, "_", i, "_", j, ".png"))
