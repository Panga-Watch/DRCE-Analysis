...
fitted_pooled <- data.frame(lin_pred = pooled_clogit$linear.predictors) # this shows all of the predicted probabilities for each of the choices offered apparently... 
