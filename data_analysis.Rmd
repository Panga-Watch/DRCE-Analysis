...
##see how much each attribute matters? 
1/(exp(standard_clogit$coefficients[2])/exp(sum(standard_clogit$coefficients[4:6]))) + #sos 6.3138 times more important the ownership?
1/(exp(standard_clogit$coefficients[2])/exp(sum(standard_clogit$coefficients[3])))+  #sos 8.061414 times more important than information? 
1/(exp(sum(standard_clogit$coefficients[4:6]))/exp(standard_clogit$coefficients[3]))  #ownership 1.218878 times more important than info?
## dont think that is right ^^ adds up to 1.095673 and I was trying to get them to add up to 1...
