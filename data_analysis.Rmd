...
standard_clogit <- clogit(RES~ASC+sos+info+own.fisher+own.industry+own.gov + strata(STR), data=standard_opt_out) # run the clogit. ASC represents the alternative specific constant, or the opt out option.
